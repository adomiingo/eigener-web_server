...
<body>
    <div class="container">
        ...
        <p class="info-text">Historial de tareas finalizadas. Se eliminarán automáticamente del servidor pasados 15
            días.</p>
                ...
                <tbody>
                    <?php foreach ($tareas as $t): ?>
                        <tr class="task-row">
                            <td>
                                ...
                                <div class="task-details">
                                    <?php if (!empty($t['beschreibung'])): ?>
                                        <p><strong>Descripción:</strong><br><?php echo nl2br(htmlspecialchars($t['beschreibung'])); ?>
                                        </p>
                                    <?php else: ?>
                            ...
                            <td><span
                                    style="color: #475569; font-weight: 500;"><?php echo htmlspecialchars($t['fach']); ?></span>
                            </td>
                            <td>
                                <span class="badge-date"><?php echo date("d-m-Y", strtotime($t['fecha_completada'])); ?></span>
                            </td>
                            <td>
                                <a href="lista_completadas.php?restaurar=<?php echo $t['id']; ?>"
                                    class="btn-action btn-restaurar" onclick="event.stopPropagation();"
                                    title="Devolver a la Agenda principal">♻️ Restaurar</a>
                                <a href="lista_completadas.php?borrar=<?php echo $t['id']; ?>" class="btn-action btn-borrar"
                                    onclick="event.stopPropagation();" title="Eliminar del servidor permanentemente">🗑️
                                    Borrar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
