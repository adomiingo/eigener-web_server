...
<head>
    ...
    <style> 
        ...
        input[type="text"], input[type="date"], textarea, select { width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 8px; margin-bottom: 20px; box-sizing: border-box;} 
        ...
        .btn { flex: 1; padding: 12px; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; text-align: center; text-decoration: none; transition: 0.2s;} 
            ...
            <select name="fach" required>
                ...
                if (!in_array($tarea['fach'], $opciones_validas) && !empty($tarea['fach'])): ?>
                    <option value="<?php echo htmlspecialchars($tarea['fach']); ?>" selected>
                        <?php echo htmlspecialchars($tarea['fach']); ?> <?php echo isset($lang['categoria_antigua']) ? $lang['categoria_antigua'] : '(Antigua)'; ?>
                    </option>
                <?php endif; ?>
            </select>
